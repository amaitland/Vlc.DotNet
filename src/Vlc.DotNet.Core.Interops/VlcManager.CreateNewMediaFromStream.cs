...
namespace Vlc.DotNet.Core.Interops
{
	public sealed partial class VlcManager
	{
		...
		public VlcMediaHandle CreateNewMediaFromStream(Stream stream)
		{
			if (stream == null)
			{
			...
			var result = GetInteropDelegate<CreateNewMediaFromCallbacks>().Invoke(
				myVlcInstance,
			...
			result.ReleaseMedia = GetInteropDelegate<ReleaseMedia>();
